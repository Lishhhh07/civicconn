      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-6">
        ...
        >
          ...
          <div className="space-y-4">
            <h2 className="text-white text-2xl">Processing Report</h2>
            <motion.p
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="flex items-center justify-between p-6 bg-slate-800/30 backdrop-blur-sm border-b border-slate-700/50">
        ...
        <div className="text-center">
          <h1 className="text-white text-xl">Report Issue</h1>
        ...
        {step === 1 && (
          ...
          >
            <div className="text-center space-y-2">
              <h2 className="text-white text-2xl">Capture Evidence</h2>
              <p className="text-slate-400">Take a photo of the issue</p>
            </div>
